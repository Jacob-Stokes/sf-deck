...
- Demo and documentation assets are now built exclusively from fictional
  Northwind data.
- Notification and Chatter response bodies are no longer written to diagnostic
  dump files.
- Dev-project record sidecars are written atomically with owner-only
  permissions.
