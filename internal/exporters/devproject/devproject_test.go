...
func TestRowsShape(t *testing.T) {
	...
	items := []devproject.Item{
		...
		},
		{
			...
			Kind: devproject.KindApexClass, Ref: "01pDM00000TEST1AAA", Type: "ApexClass",
...
// TestSuggestedFilename pins the default export filename behaviour for common
// shapes without duplicating the slug helper's full test matrix.
