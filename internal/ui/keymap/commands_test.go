...
// knownConflicts is the allowlist of documented dispatcher key shadows.
// Each entry is a
...
var knownConflicts = map[string]string{
	...
	// Each context handler runs before the global one because the dispatcher
	// checks tab/modal context first.
