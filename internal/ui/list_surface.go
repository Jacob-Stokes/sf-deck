...
// List surface registry, companion to chipSurface and openSurface.
//
// listSurface answers the shared "where is this list's state?" question for:
//
...
//
// Dispatch walks the registry and falls back to bespoke arms only for
// surfaces with idiosyncratic state shapes.
