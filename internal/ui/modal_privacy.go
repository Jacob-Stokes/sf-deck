...
func (m *Model) openPrivacyModal() tea.Cmd {
	...
	rows := []infoRow{
		...
		{Body: "Metadata caches, settings, histories, saved comparisons, projects, tags, logs, error dumps, and enabled diagnostic traces may be stored locally under ~/.sf-deck."},
		{Body: "Apex execution history can include submitted code and captured debug-log bodies."},
		{},
