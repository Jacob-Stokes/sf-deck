...
//
// Cache discipline: prefer the cached baseline Resource when fresh and fall
// back to a direct fetch only when it is empty or unavailable. This avoids
// duplicate describe, Tooling, and EntityDefinition calls within the TTL.
