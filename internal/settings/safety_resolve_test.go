...
// TestResolveRaceWithSetOrg exercises IPC goroutines mutating safety via
// SetOrg/PinDefault while the TUI resolves gate decisions via
// Resolve/DefaultOrgUsername. Run with -race to verify the locking contract.
