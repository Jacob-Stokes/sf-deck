...
- Never include real-org names, aliases, usernames, IDs, metadata names,
  logs, IPs, screenshots, or other identifying data.
...
- [ ] Test data, logs, screenshots, comments, and commit messages contain no real-org information
- [ ] Commit messages explain WHY, not WHAT

## Test plan

<!--
How did you verify this? Describe fixtures and manual steps, but never
identify a real org or paste real org data. Use generic labels such as
"throwaway sandbox" and sanitised Northwind examples. "ran tests" alone
is fine for small refactors but not for behaviour changes.
-->
